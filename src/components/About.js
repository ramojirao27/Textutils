...
const About = () => {
  ...
  {darkMode?
    <button className='btn btn-primary my-3 ' onClick={()=>setDarkMode((prev)=>!prev)}>Disable DarkMode</button>:
    <button className='btn btn-primary my-3' onClick={()=>setDarkMode((prev)=>!prev)}>Enable Dark Mode</button>}
